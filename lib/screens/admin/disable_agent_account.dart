...
class DisableAgentAccount extends StatefulWidget {
  const DisableAgentAccount({super.key});
  static const routeName = '/disable-agent-account';

  @override
  State<DisableAgentAccount> createState() => _DisableAgentAccountState();
}

class _DisableAgentAccountState extends State<DisableAgentAccount> {
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            Text('Agent désactivé, demandez lui de se connecter à son compte'),
        actions: [
          TextButton(
              onPressed: () {
